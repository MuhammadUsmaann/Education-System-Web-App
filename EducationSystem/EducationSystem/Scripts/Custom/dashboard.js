jQuery(document).ready(function ($) {
			        ...
			        // Yearly Result Comparission 
			        var yearlydataSource = [{
			            state: "2011",
			            thirdterm: 83.82,
			            secondterm: 79.36,
			            firstterm: 87.52
			        ...
			        $("#yearlycontainer").dxChart({
			            ...
			            series: [
                            { valueField: "firstterm", name: "First Term" },
                            { valueField: "secondterm", name: "Second Term" },
                            { valueField: "thirdterm", name: "Third Term" }
			            ],
			            title: "Last three year result comparison",
			            legend: {
			        ...
			        $("#pageviews-visitors-chart").dxChart({
			            ...
			            series: [
							{ valueField: "part1", name: "Current Year", color: "#68b828" },
							{ valueField: "part2", name: "Previous Year", color: "#eeeeee" },
			            ],
			            legend: {
			                position: 'inside',
			                paddingLeftRight: 5
